...
model_engine = "text-davinci-003"                  # Define the model engine to be used
...
def play_audio_file():
    # play the audio file
    os.system("mpg321 response.mp3")       # Use the mpg321 command-line mp3 player to play the audio
...
def main():
    ...
    message = responses.choices[0].text  # Extract the text from the response
    print(message)
